...
public class NormQueryEngineDtw {
    ...
    public List<Pair<Integer, Double>> query(List<Double> queryData, double epsilon, int rho, double alpha, double beta) throws IOException {
...
//            logger.info("next valid: {}", validPositions.toString());
        ...
        Arrays.sort(tmpQ, (o1, o2) -> {
            ...
            if(Math.abs(o2.value)>Math.abs(o1.value))
                return 1;
            else if(Math.abs(o2.value)<Math.abs(o1.value))
                return -1;
            else
                return 0;
        });
