...
import kvmatch.common.IndexCache;
import kvmatch.common.Interval;
import kvmatch.common.Pair;
import kvmatch.common.QuerySegment;
...
public class QueryEngine {
    ...
    public List<Pair<Integer, Double>> query(List<Double> queryData, double epsilon) throws IOException {
