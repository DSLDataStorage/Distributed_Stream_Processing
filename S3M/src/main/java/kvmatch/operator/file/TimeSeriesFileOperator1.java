 ...
 */
public class TimeSeriesFileOperator1 implements TimeSeriesOperator {

    private static final Logger logger = LoggerFactory.getLogger(TimeSeriesFileOperator1.class.getName());
    ...
    public TimeSeriesFileOperator1(int N, boolean rebuild) throws IOException {
        this.N = N;
        fileHandler = new FileHandler("files" + File.separator + "target-" + N, rebuild ? "w" : "r");
    }
